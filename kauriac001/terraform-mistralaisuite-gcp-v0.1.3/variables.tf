...
variable "cluster_autopilot" {
  type        = bool
  description = "Cluster autopilot mode"
  default     = false
}
...
variable cert_manager_create {
  description = "Whether to create the cert-manager"
  type        = bool
  default     = false
}
...
variable "cert_manager_acme_email" {
  description = "ACME Email for Let's Encrypt (used in ClusterIssuer)"
  type        = string
  default     = ""
}
...
variable "apisix_load_balancer_ip_name" {
  type        = string
  description = "Name for the Apisix load balancer IP resource"
  default     = ""
}

variable "apisix_load_balancer_ip_address" {
  type        = string
  description = "IP address to reserve for the Apisix load balancer"
  default     = ""
}
