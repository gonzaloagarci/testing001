environment = "xxt"
host_project_id = "gc-pr-xxt-7434-internal-sh-vpc"
seed_project_id = "gc-pr-xxt-7765-kaur-mistral"
random_string_length = 8
random_string_special = false
project_id = "gc-pr-xxt-7765-kaur-mistral"
region = "europe-southwest1"
prefix = "mistral-ai-suite-"
network_vpc_create = false
network_vpc_name = "gc-sh-vpc-xxt-internal-base-spoke"
network_vpc_name_selflink = "projects/gc-pr-xxt-7434-internal-sh-vpc/global/networks/gc-sh-vpc-xxt-internal-base-spoke"
network_subnet_name = "gc-sh-vpc-sb-xxt-internal-base-spoke-449252362511-eu-sw1"
network_subnet_selflink = "projects/gc-pr-xxt-7434-internal-sh-vpc/regions/europe-southwest1/subnetworks/gc-sh-vpc-sb-xxt-internal-base-spoke-449252362511-eu-sw1"
network_pods_subnet_name = "gc-sh-vpc-sb-xxt-internal-base-spoke-449252362511-eu-sw1-1"
network_lb_subnet_name = "gc-sh-vpc-sb-xxt-internal-base-spoke-449252362511-eu-sw1-2"
network_private_endpoint_subnet_selflink = "projects/gc-pr-xxt-7434-internal-sh-vpc/regions/europe-southwest1/subnetworks/gc-sh-vpc-sb-xxt-internal-base-spoke-449252362511-eu-sw1-2"
#apisix_load_balancer_ip_name = "gc-int-lb2-xxt-internal-base-spoke-449252362511-eu-sw1-2"
#apisix_load_balancer_ip_address = "172.24.109.228"
apisix_load_balancer_ip_name = "gc-int-lb-xxt-internal-base-spoke-449252362511-eu-sw1-2"
apisix_load_balancer_ip_address = "172.24.109.227"
...
kms_crypto_key_id = ""
iam_create = false
iam_service_account_email = "gc-sa-xxt-kaur-gke-cluster-acc@gc-pr-xxt-7765-kaur-mistral.iam.gserviceaccount.com"
...
cluster_kubernetes_version = "1.33.5-gke.2019000"
cluster_kubernetes_general_node_version = "1.33.5-gke.2019000"
cluster_kubernetes_internal_node_version = "1.33.5-gke.2019000"
